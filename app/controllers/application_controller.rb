class ApplicationController < ActionController::Base
  ...
  def shopstylecall
    limit = 50
    shopstyle_response_api = open("http://api.shopstyle.com/api/v2/products?pid=#{Dotenv.load["SHOPSTYLE_TOKEN"]}&fts=#{image_query}+#{search_word}&fl=p10&fl=p11&fl=p12&fl=p9&limit=#{limit}").read
